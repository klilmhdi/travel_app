...
import 'package:travel_app/share/widgets/appButton.dart';
            ...
            children: [
                          ...
                          children: [
                            Wrap(
                              children: List.generate(5, (index) {
                                return Icon(
                                  Icons.star,
                                  color: detail.places.starts > index ? AppColors.starColor : AppColors.mainTextColor,
                                );
                              }),
                            ),
                            const SizedBox(
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                        onPressed: () => {BlocProvider.of<AppCubit>(context).goBack()},
                        icon: const Icon(
                    ...
                    IconButton(
                      onPressed: () => {},
                      icon: const Icon(Icons.short_text, size: 30, color: Colors.white),
                    ),
                  ],
                ),
              ),
